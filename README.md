...
//	//strcat
//	//strncat
//	//strcat(str1,str1)//自己给自己追加 - 程序崩溃 - strcat函数不能用来自己给自己追加
//	strncat(str1,str1,6);//str1 里面为 abcdefabcdef
//	//2.判断str2指向的字符串是否是str1指向的字符串的子串
//	//strstr - 找子串的
//	char* ret = strstr(str1, str2);//在str1里面找一找有没有str2这个子串//如果找到返回c的地址，如果找不到返回空指针
//	if (ret == NULL)
//	{
//		return 0;
//	}
...
//	char arr1[30] = "abc";
//	char arr2[] = "def";
//	strcat(arr1, arr2);//把arr2这个字符串追加到arr1中去
//	printf("%s\n", arr1);
//	return 0;
////}
